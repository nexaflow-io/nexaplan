...
export default function FAQSection() {
  const faqs = [
    ...
    {
      question: "作成したプレゼンテーションはどのように共有できますか？",
      answer: "作成したプレゼンテーションはPDFやHTMLとしてエクスポートできます。また、共有リンクを生成して他の人と直接共有することも可能です。将来的にはチーム機能も追加予定です。"
    },
    {
    ...
    },
    {
      ...
      answer: "現在のバージョンではインターネット接続が必要ですが、将来的にはオフラインモードの提供も検討しています。特にAI機能を使用しない基本的な編集機能については、オフライン対応を進めていく予定です。"
    },
    {
